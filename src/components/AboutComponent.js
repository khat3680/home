        ...
        <div className="container">
            ...
            <div className="row row-content">
                <div className="col-12 col-md-6">
                    <h2>Hello!!</h2>
                    <p>I am a university student studying Computer Science, currently deploying a Masks / No Mask Model on Android using react and Android SDK. I currently have good experience in Python, C and javascript. I am currently learning Java and its object oriented properties, Software Engineering, Microprocessors and Entrepreneur Skills.</p>
                </div>
                    ...
                    <Card>
                        <CardBody className="bg-faded">
                            <blockquote className="blockquote">
                                <p className="mb-0">There is no pill to convert yourself as a good programmer, it takes lots of reading, learning and practice. So start now.</p>
                                <footer className="blockquote-footer">Geshan Manandhar
